...
public class HR {
	...
	public HR(int cid, String cname, int problem_solving, int adaptability, int team_work, int final_rating) {
		super();
		this.cid = cid;
		this.cname = cname;
	...
	public String toString() {
		return "HR [cid=" + cid + ", cname=" + cname + ", problem_solving=" + problem_solving + ", adaptability="
